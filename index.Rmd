...
author: "The LIST IG Cross-Team Group"
date: "`r Sys.Date()`"
...
description: |
  This is a handbook created by the LIST IG Cross-Team Group to support the wider LIST team around Information Governance
link-citations: yes
github-repo: rstudio/bookdown-demo
---

```{r include = FALSE}
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, fig.path = "./imgs/")
```
...
1. Get in touch with individual members of the IG Group directly.

**LIST IG Group Members**
